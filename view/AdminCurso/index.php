...
<body>
    ...
    <div class="br-mainpanel">
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            ...
            <p class="mg-b-0">Mantenimiento de cursos</p>
        </div>
        ...
        <?php require_once("modalimg.php") ?>
        <?php require_once("../html/MainJs.php") ?>
        <script src="admincurso.js" type="text/javascript"></script>
</body>
